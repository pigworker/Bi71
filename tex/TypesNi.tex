...
\end{array}\]
When a variable has object sort, $x\in\iota\fae\Gamma$, its argument spine is empty, and we may abbreviate the term $x[\EC]$ to plain old $x$.
...
For human readability, let us continue to write example terms by binding \emph{names}, $\bnd xt$. A $\beta$-redex looks like
\[
